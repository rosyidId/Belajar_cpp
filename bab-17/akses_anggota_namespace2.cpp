/******************************************************
Nama file: akses_anggota_namespace2.cpp
*******************************************************/
...
// mengakses anggota-anggota namespace BangunDatar
using BangunDatar::PersegiPanjang;
using BangunDatar::BujurSangkar;
using BangunDatar::Segitiga;
using BangunDatar::Lingkaran;

int main() {   
   // mendeklarasikan objek bertipe PersegiPanjang
   PersegiPanjang pp(10,8);
